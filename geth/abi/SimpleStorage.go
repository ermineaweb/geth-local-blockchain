...
var SimpleStorageMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"getData\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"d\",\"type\":\"uint256\"}],\"name\":\"setData\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
func (_SimpleStorage *SimpleStorageCaller) GetData(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _SimpleStorage.contract.Call(opts, &out, "getData")
...
//
// Solidity: function getData() view returns(uint256)
func (_SimpleStorage *SimpleStorageSession) GetData() (*big.Int, error) {
	return _SimpleStorage.Contract.GetData(&_SimpleStorage.CallOpts)
}

// GetData is a free data retrieval call binding the contract method 0x3bc5de30.
//
// Solidity: function getData() view returns(uint256)
func (_SimpleStorage *SimpleStorageCallerSession) GetData() (*big.Int, error) {
	return _SimpleStorage.Contract.GetData(&_SimpleStorage.CallOpts)
}

// SetData is a paid mutator transaction binding the contract method 0x5b4b73a9.
//
// Solidity: function setData(uint256 d) returns()
func (_SimpleStorage *SimpleStorageTransactor) SetData(opts *bind.TransactOpts, d *big.Int) (*types.Transaction, error) {
	return _SimpleStorage.contract.Transact(opts, "setData", d)
}

// SetData is a paid mutator transaction binding the contract method 0x5b4b73a9.
//
// Solidity: function setData(uint256 d) returns()
func (_SimpleStorage *SimpleStorageSession) SetData(d *big.Int) (*types.Transaction, error) {
	return _SimpleStorage.Contract.SetData(&_SimpleStorage.TransactOpts, d)
}

// SetData is a paid mutator transaction binding the contract method 0x5b4b73a9.
//
// Solidity: function setData(uint256 d) returns()
func (_SimpleStorage *SimpleStorageTransactorSession) SetData(d *big.Int) (*types.Transaction, error) {
	return _SimpleStorage.Contract.SetData(&_SimpleStorage.TransactOpts, d)
}
